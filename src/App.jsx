...
const [millisecs,setMillisecs]=useState(700);
  ...
  return (<><h3 id="title">Conway's Game of Life</h3><main><div id="part1">
...
<div className="btn-group wrapper" style={{flexDirection:"row"}}>
<button className="btn-custom" id="btn1" onClick={() => {
setRunning(!running);
if (!running) {
...
<button className="btn-custom" id="btn2" onClick={()=>handleClick(0,randomGrid)}>Random</button>
<button className="btn-custom" id="btn3"
  onClick={() => 
  handleClick(1,patterns1)}><span>Patterns 1</span></button>
<button className="btn-custom" id="btn4" onClick={()=>handleClick(2,patterns2)}>Patterns 2</button>
<button className="btn-custom" id="btn5" onClick={()=>handleClick(-1,emptyGrid)}>&nbsp;&nbsp;Clear&nbsp;&nbsp;</button></div>
  <div className="wrapper">
    ...
    return(<div key={cell.id}
      ...
      })}</div></div><p id="gen">Generation: {gen}</p></div>
<div id="part2" className="wrapper">
